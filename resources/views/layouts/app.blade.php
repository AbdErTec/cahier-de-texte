            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item me-4 p-1 ">
                            <a href="{{ url('/cahierTexte')}}">Mes Cahiers</a>
                        </li>
                        <li class="nav-item me-4 p-1 ">
                            <!-- <a style="text-decoration:none;color: white;" href="{{ url('/')}}">Mes Modules</a> -->
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a style="text-transform:upercase  ;" id="navbarDropdown" class="nav-link dropdown-toggle text-uppercase" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
